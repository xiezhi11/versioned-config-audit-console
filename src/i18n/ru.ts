...
export const ru = {
  ...
  migration: {
    title: 'Миграция структурированного конфига',
    intro: 'Миграция строго по объявленной цепочке версий с аудитом различий. Обычное чтение Alertmanager не изменено.',
    back: 'К редактору', config: 'Структурированный конфиг', rules: 'Правила, зафиксированные по версиям',
    from: 'Версия данных', to: 'Целевая версия', actor: 'Оператор', preflight: 'Запустить预检',
    parseFailed: 'Структурный разбор не удался.', badRules: 'Правила не являются валидным JSON/YAML.', stopped: 'Миграция остановлена.',
    export: 'Экспортировать审阅', import: 'Импортировать审阅', newReview: 'Новый разбор', batch: 'Принять все ожидающие',
    search: 'Поиск с сохранением стабильного порядка', fingerprint: 'Отпечаток рабочего файла', ruleFingerprint: 'Отпечаток правил',
    oldValue: 'Старое значение', newValue: 'Новое значение / источник', sources: 'Исходные пути', affected: 'Затронутая ветка',
    manual: 'Ручное значение (JSON)', saveManual: 'Сохранить источник', accept: 'Принять', reject: 'Отклонить', history: 'История', origin: 'Исходное местоположение',
    status: { all: 'Все', pending: 'Ожидают', accepted: 'Принято', rejected: 'Отклонено', conflict: 'Конфликт', unknown: 'Неизвестное' },
  },
